...
sudo openssl req -new -x509 -days 36500 -key /etc/sing-box/private.key -out /etc/sing-box/cert.crt -subj "/CN=bing.com"
echo -e "{
    \x22inbounds\x22: [
        {
            \x22type\x22: \x22hysteria2\x22,
            ...
            \x22tls\x22: {
                \x22enabled\x22: true,
                \x22certificate_path\x22: \x22/etc/sing-box/cert.crt\x22,
                \x22key_path\x22: \x22/etc/sing-box/private.key\x22
            }
        }
    ],
    \x22outbounds\x22: [
